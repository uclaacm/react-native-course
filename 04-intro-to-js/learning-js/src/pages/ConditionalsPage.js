...
export default function ConditionalsPage() {
  ...
  /*TODO: Make a function that teaches about how conditionals work in JavaScript!
  ...
  return (
    <div className="page">
      <div className="description">
        <div className="title-text">Conditionals</div>
        <p>
      ...
      {/* TODO: For conditionals, it could be helpful to visualize to the student how output would differ depending on the branches.
      Maybe show an example of how the output to their function could differ depending on the path that the conditional takes? */}
