...
export default function VariablesPage() {
  ...
  /*TODO: Make a function that teaches about using variables in functions 
  and how they can help separate logic and how they can be used.
  ...
  return (
    <div className="page">
      <div className="description">
        <div className="title-text">Variables</div>
        <p>
