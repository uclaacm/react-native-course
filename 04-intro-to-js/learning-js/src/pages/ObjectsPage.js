...
export default function ObjectsPage() {
  ...
  /*TODO: Make a function that teaches about how objects work in JavaScript!
  ...
  return (
    <div className="page">
      <div className="description">
        <div className="title-text">Objects</div>
        <p>
      ...
      {/* TODO: For objects, it could be helpful to visualize to the student how the JSON of the object looks as well!
      Maybe make a table out of the object's Object.entries ? */}
