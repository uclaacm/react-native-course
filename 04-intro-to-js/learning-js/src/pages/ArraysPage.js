...
export default function ArraysPage() {
  ...
  /*TODO: Make a function that teaches about how arrays work in JavaScript!
  ...
  return (
    <div className="page">
      <div className="description">
        <div className="title-text">Arrays</div>
        <p>
      ...
      {/* TODO: For arrays, it could be helpful to visualize to the student how the array looks in memory!
      Maybe even allow them to push/pop things from the array with the input */}
